{{-- filepath: resources/views/cashier/orders/show.blade.php --}}
<x-app-layout>
    <x-slot name="header">
    ...
    <div class="py-6 max-w-2xl mx-auto">
        <div class="bg-white p-6 rounded shadow">
            ...
            <form action="{{ route('orders.complete', $order) }}" method="POST">
                @csrf
                <button type="submit" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded">Tandai Selesai</button>
            </form>
            @endif
        </div>
    </div>
